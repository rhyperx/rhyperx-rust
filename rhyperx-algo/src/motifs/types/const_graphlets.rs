...
pub const TRIANGLE: CompactMotif3 = {
    ...
    rv.add_edge_with_nodes([0, 1]);
    rv.add_edge_with_nodes([0, 2]);
    rv.add_edge_with_nodes([1, 2]);
    rv
};
...
pub const FOUR_CLIQUE: CompactMotif4 = {
    ...
    rv.add_edge_with_nodes([0, 1]);
    rv.add_edge_with_nodes([0, 2]);
    rv.add_edge_with_nodes([0, 3]);
    rv.add_edge_with_nodes([1, 2]);
    rv.add_edge_with_nodes([1, 3]);
    rv.add_edge_with_nodes([2, 3]);
    rv
};
...
pub const PAW: CompactMotif4 = {
    ...
    rv.add_edge_with_nodes([0, 1]);
    rv.add_edge_with_nodes([1, 2]);
    rv.add_edge_with_nodes([2, 0]); // Triangle
    rv.add_edge_with_nodes([2, 3]); // Tail
    rv
};
...
pub const FOUR_ISOLATED: CompactMotif4 = CompactMotif4::EMPTY;
