...
use rhyperx_core::hypergraph::{HxSetStore, HxUnsizedRef, Hypergraph};
...
impl Loader for ConferenceStdUnweightedLoader {
    ...
    fn from_file(&self) -> Result<Self::Output, LoaderError> {
        ...
        for (_t, edge_list) in time_edges.into_iter() {
            for mut clique in build_clique_hyperedges(edge_list, false) {
...
impl Loader for ConferenceStdWeightedLoader {
    type Output = Hypergraph<u32, f32, HxSetStore<u32, f32>>;
